...
from transformers import (OpenAIGPTLMHeadModel, AdamW, BertTokenizer, WEIGHTS_NAME, CONFIG_NAME)

from utils.inputter_wb import build_dataloaders, USER, BOT
from utils.dataset_wb import IGNORE_INDEX
...
def train():
    ...
    tokenizer = tokenizer_class.from_pretrained(args.model_checkpoint, do_lower_case=True, never_split=[USER, BOT])
